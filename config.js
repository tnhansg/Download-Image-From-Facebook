...
export const ACCESS_TOKEN = ""; //Token acc facebook
export const WAIT_BEFORE_NEXT_FETCH = 2000; // thời gian chờ (ms) trước mỗi lần fetch tiếp theo
export const WAIT_BEFORE_NEXT_FETCH_LARGEST_PHOTO = 2000; // thời gian chờ (ms) trước khi tải ảnh có độ phân giải lớn. Nếu chờ ít thì rất dễ bị facebook ban
export const ID_LINK_SEPERATOR = ";";
export const PHOTO_FILE_FORMAT = "jpg"; // OR jpg
